...
group = subgroup
base.archivesName.set("simply-no-shading-fabric-1_16_5")

val gameVersion by extra("1.16.5")
val minecraftVersion by extra("1.16.5")
...
dependencies {
    ...
    // BedrockIfy
    modCompileOnly("maven.modrinth:bedrockify:1.1.0+mc1.16")
    ...
    // SpruceUI
    include(modImplementation("com.github.LambdAurora:SpruceUI:2.1.3-1.16") {
        exclude(mapOf("module" to "fabric-loader"))
    })
}
