...
public class DecoratedPotRendererMixin {
    @WrapOperation(
        method = {
            "render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;IILnet/minecraft/world/level/block/entity/PotDecorations;)V",
            "renderSide",
        },
        at = @At(
            value = "INVOKE",
