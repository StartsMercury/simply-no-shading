...
public class DecoratedPotRendererMixin {
    @WrapOperation(
        method = {
            "render(Lnet/minecraft/world/level/block/entity/DecoratedPotBlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;II)V",
            "renderSide",
        },
        at = @At(
            value = "INVOKE",
    ...
    private VertexConsumer modifyDecoratedPotRenderType(
