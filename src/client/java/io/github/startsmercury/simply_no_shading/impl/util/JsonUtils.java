...
public final class JsonUtils {
    ...
    static void serializeAndExtractMembers(
        ...
        if (node == null) {
            ...
            writer.nullValue();
        } else if (node instanceof JsonPrimitive jsonPrimitive && jsonPrimitive.isBoolean()) {
            writer.value(jsonPrimitive.getAsBoolean());
        } else if (node instanceof JsonPrimitive jsonPrimitive && jsonPrimitive.isNumber()) {
            writer.value(jsonPrimitive.getAsNumber());
        } else if (node instanceof JsonPrimitive jsonPrimitive) {
