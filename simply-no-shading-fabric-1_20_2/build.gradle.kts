...
group = subgroup
base.archivesName.set("simply-no-shading-fabric-1_20_2")

val gameVersion by extra("1.20.2")
val minecraftVersion by extra("1.20.2")
...
dependencies {
    val fabricApiVersion = "0.91.2+1.20.2"
    ...
    // ModMenu
    "modClientImplementation"("com.terraformersmc:modmenu:8.0.1") {
        exclude(mapOf("module" to "fabric-loader"))
    }

    // Sodium
    "modSodiumClientAuto"("maven.modrinth:sodium:mc1.20.2-0.5.5")
